...
def _compile_disagg_sessions(
    ...
    *,
    ...
    prefill_user_tiled: bool = False,
    prefill_offload_pt_weights: bool | None = None,
):
    effective_prefill_depth_first = False if prefill_user_tiled else prefill_enable_depth_first
    print(
        ...
        f"prefill_user_tiled={prefill_user_tiled}, "
        f"prefill_depth_first={effective_prefill_depth_first}, data_path_timeout_ms={DATA_PATH_TIMEOUT_MS}"
    )
    ...
    prefill_compile_kwargs = {
        ...
        "mxfp6_matmul": False,
        "mxint8_kv_cache": False,
        "aic_enable_depth_first": effective_prefill_depth_first,
